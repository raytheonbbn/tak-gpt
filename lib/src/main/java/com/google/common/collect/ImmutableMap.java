...
// ** THIS IS COPIED HERE SINCE TAK SERVER DEPENDS ON A CONFLICTING VERSION OF GUAVA
// ** THIS CODE IS FROM https://github.com/google/guava/blob/v31.0/guava/src/com/google/common/collect/ImmutableMap.java
